defmodule StimporiumWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(StimporiumWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(StimporiumWeb.Gettext, "errors", msg, opts)
    end
  end
